...
public final class CommandAPDU implements java.io.Serializable {
    ...
    // the code is taken from http://www.java2s.com/example/java-src/pkg/javax/smartcardio/commandapdu-19098.html
    ...
    private void parse() {
        ...
        if (l2 == 0) {
            throw new IllegalArgumentException(
                    "Invalid APDU: length=" + apdu.length + ", b1=" + l1 + ", b2||b3=" + l2);
        }
